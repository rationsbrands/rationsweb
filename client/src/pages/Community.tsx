...
export default function Community({ embed = false }) {
  ...
  return (
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50 py-8 sm:py-20">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 text-center">
        ...
        <h1 className="mt-4 text-2xl sm:text-5xl font-extrabold text-[#0C1E22] tracking-tight">
          Join the <span className="text-[#FDCD2F]">Rations</span> Community
        </h1>
        <p className="mx-auto mt-3 max-w-2xl text-sm sm:text-lg text-gray-700">
            ...
            {SITE.socials.filter(s => !!s.url).map((social) => {
              ...
              return (
                <a
                  ...
                  className="group relative flex items-center justify-center rounded-xl border border-gray-100 bg-white p-2 sm:p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FDCD2F]/60"
                  style={{ color: '#0C1E22' }}
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6">
        <h2 className="text-lg sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Community Posts</h2>

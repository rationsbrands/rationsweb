...
export default function Contact() {
  ...
  return (
    <section className="bg-[#F9FAFB] py-6 sm:py-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
  {/* Page Header */}
        <h1 className="text-2xl sm:text-4xl font-extrabold text-center text-ration-dark mb-6 sm:mb-14">
         Contact Us
        </h1>
        <div className="grid md:grid-cols-2 gap-6 sm:gap-10 items-center">
         {/* Contact Info Card */}
          <div className="bg-white rounded-2xl p-3 sm:p-8 space-y-4 sm:space-y-8 shadow-sm hover:shadow-lg transition-shadow">
            <h2 className="text-lg sm:text-2xl font-bold text-ration-dark">
